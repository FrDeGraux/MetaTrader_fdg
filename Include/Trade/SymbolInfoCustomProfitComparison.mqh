...
public:
   ...
   bool              init(CArrayString &swap_rates[],CArrayString &com_calibs[]);
//,CArrayString &positions_to_compare_against[]
   double computeProfitComparisonEquity();
   bool initPositions(CArrayString &positions_to_compare_against[]);
...
//+------------------------------------------------------------------+
bool  CSymbolInfoCustomProfitComparison::init(CArrayString &swap_rates[],CArrayString &com_calibs[])
//+------------------------------------------------------------------+
  {
  ...
  bool  CSymbolInfoCustomProfitComparison::initPositions(CArrayString &positions_to_compare_against[])
  {
