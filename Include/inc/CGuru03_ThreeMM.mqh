...
class CGuruEx03_ThreeMM : public CGuruEx03_Base
  {
  public :                   
                     CGuruEx03_ThreeMM(int slowPeriod,int mediumPeriod,int intFastPeriod,int hysterisis,int ATR_MAPeriod);               // Constructor
                    ~CGuruEx03_ThreeMM() { Deinit(); }  // Destructor

   void              Deinit();
   bool              InitIndicators();
   bool              Init(string Pair,int slippage,double lot);
 ...
 CGuruEx03_ThreeMM::CGuruEx03_ThreeMM(int slowPeriod,int mediumPeriod,int intFastPeriod,int hysterisis,int _ATR_MAPeriod)
  {
  CGuruEx03_Base::CGuruEx03_Base(ATR_MAPeriod,magicNumber);
  ticks = 0;
 m_Fast = NULL;
   m_Slow = NULL;
   m_Medium = NULL;
   ...
   bool CGuruEx03_ThreeMM::Init(string Pair,int slippage,double lot)
   {
     if(!CGuruEx03_Base::Init(Pair,slippage,lot))
