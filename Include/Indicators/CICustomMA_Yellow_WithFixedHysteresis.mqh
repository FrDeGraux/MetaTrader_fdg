...
#define INDICATOR_NAME "Custom Moving Average Input Color_Yellow_WithFixedhysteresis"

#define HYSTERESIS_NBUFFERS 5
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
class CiCustomMA_Yellow_WithFixed_Hysteresis : public CICustomMA
  {
private:
   int               window_backward;
   int               long_ma_period;
...
public:
                     CiCustomMA_Yellow_WithFixed_Hysteresis(int _window_backward,double _long_ma_period);
                    ~CiCustomMA_Yellow_WithFixed_Hysteresis();
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CiCustomMA_Yellow_WithFixed_Hysteresis::Create(const string symbol,const ENUM_TIMEFRAMES period,
               const int ma_period,const int ma_shift,
               const ENUM_MA_METHOD ma_method,const int applied,CMqlParams& params)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
CiCustomMA_Yellow_WithFixed_Hysteresis::CiCustomMA_Yellow_WithFixed_Hysteresis(int _window_backward,double _long_ma_period) :  CICustomMA(INDICATOR_NAME,HYSTERESIS_NBUFFERS)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
CiCustomMA_Yellow_WithFixed_Hysteresis::~CiCustomMA_Yellow_WithFixed_Hysteresis()
  {

  }
//+------------------------------------------------------------------+
bool CiCustomMA_Yellow_WithFixed_Hysteresis::Initialize(const string symbol, 
                              const ENUM_TIMEFRAMES period, 
                              const int num_params, 
                              const MqlParam &params[]
) 
