...
//+------------------------------------------------------------------+
class CiCustom_Enhanced : public CIndicator_Enhanced
  {
protected:
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CiCustom_Enhanced::CiCustom_Enhanced(void) : m_num_params(0)
  {
  }
//+------------------------------------------------------------------+
//| Destructor                                                       |
//+------------------------------------------------------------------+
CiCustom_Enhanced::~CiCustom_Enhanced(void)
  {
  }
//+------------------------------------------------------------------+
//| Set number of buffers of indicator                               |
//+------------------------------------------------------------------+
bool CiCustom_Enhanced::NumBuffers(const int buffers)
  {
   bool result=true;
//---
...
//+------------------------------------------------------------------+
ENUM_DATATYPE CiCustom_Enhanced::ParamType(const int ind) const
  {
   if(ind>=m_num_params)
      return(WRONG_VALUE);
//---
...
//+------------------------------------------------------------------+
long CiCustom_Enhanced::ParamLong(const int ind) const
  {
   if(ind>=m_num_params)
      return(0);
...
//+------------------------------------------------------------------+
double CiCustom_Enhanced::ParamDouble(const int ind) const
  {
   if(ind>=m_num_params)
      return(EMPTY_VALUE);
   switch(m_params[ind].type)
...
//+------------------------------------------------------------------+
string CiCustom_Enhanced::ParamString(const int ind) const
  {
...
//+------------------------------------------------------------------+
bool CiCustom_Enhanced::Initialize(const string symbol,const ENUM_TIMEFRAMES period,const int num_params,const MqlParam &params[])
  {
   int  i;
//--- tune
   if(m_buffers_total==0)
