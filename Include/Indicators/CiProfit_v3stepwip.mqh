...
//+------------------------------------------------------------------+
double CIProf::Main(const int index) const
  {
...
//+---
bool CIProf::Create(  string symbol,ENUM_TIMEFRAMES tf)
{
...
bool CIProf::Initialize(const string symbol, 
                              const ENUM_TIMEFRAMES period, 
                              const int num_params, 
                              const MqlParam &params[]
) {
