...
class dbCalendarClass
{
public : 
 dbCalendarClass(string in_sDBFilePath);
 bool openDataBase();
void closeDB();
int getDB();
 bool fromRecordToInsertQuery(string table_name);
private : 
bool isDBClosed;
int db;
string db_name;
};
int dbCalendarClass::getDB()
{return db;}
void dbCalendarClass::closeDB()
{
 DatabaseClose(this.db);
 this.isDBClosed = 1;
}
bool dbCalendarClass::openDataBase()
{
if(this.db_name=="")
     {
...
dbCalendarClass::dbCalendarClass(string database_name)
{
